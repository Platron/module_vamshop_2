...
class PlatronController extends PaymentAppController {
	public $uses = array('PaymentMethod', 'Order');
	public $module_name = 'Platron';
	public $icon = 'platron.png';
	...
	public function before_process () 
	{
		...
		$strCallBack = 'http://'.$_SERVER['HTTP_HOST'] .  BASE . '/payment/platron/result/index.php';
		...
		$arrFields = array(
			...
			'pg_currency'			=> $_SESSION['Customer']['currency_code'],
